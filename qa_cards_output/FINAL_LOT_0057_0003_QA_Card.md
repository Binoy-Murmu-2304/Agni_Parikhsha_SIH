...
**Component ID**: `FINAL_LOT_0057_0003`
...
- **Measured at 24h**: 0.44
- **Predicted 168h**: 0.58 dps vs Spec Max 0.5 dps ? forecast exceeds limit
- **Conformal Interval (90%)**: +/- 0.08
- **Safety Slope Margin**: -0.0117 (allowed - measured max slope)
