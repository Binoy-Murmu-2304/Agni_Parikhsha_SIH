...
**Component ID**: `FINAL_LOT_0051_0026`
...
- **Measured at 24h**: 72.13
- **Predicted 168h**: 205.79 µA vs Spec Max 75.0 µA ? forecast exceeds limit
- **Conformal Interval (90%)**: +/- 28.05
- **Safety Slope Margin**: -2.3869 (allowed - measured max slope)
