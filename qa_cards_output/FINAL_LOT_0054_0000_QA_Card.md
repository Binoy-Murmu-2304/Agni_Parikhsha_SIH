...
**Component ID**: `FINAL_LOT_0054_0000`
**Family**: `IMAGE_SENSOR`
...
- **Measured at 24h**: 1.73
- **Predicted 168h**: 4.13 nA/cm² vs Spec Max 10.0 nA/cm²
- **Conformal Interval (90%)**: +/- 2.55
- **Safety Slope Margin**: -0.0196 (allowed - measured max slope)
