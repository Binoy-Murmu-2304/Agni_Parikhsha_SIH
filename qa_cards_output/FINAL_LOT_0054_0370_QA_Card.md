...
**Component ID**: `FINAL_LOT_0054_0370`
**Family**: `IMAGE_SENSOR`
...
- **Measured at 24h**: 11.76
- **Predicted 168h**: 20.46 nA/cm² vs Spec Max 10.0 nA/cm² ? forecast exceeds limit
- **Conformal Interval (90%)**: +/- 2.55
- **Safety Slope Margin**: -0.4282 (allowed - measured max slope)
