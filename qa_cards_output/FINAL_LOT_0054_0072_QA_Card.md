...
**Component ID**: `FINAL_LOT_0054_0072`
**Family**: `IMAGE_SENSOR`
...
- **Measured at 24h**: 9.82
- **Predicted 168h**: 11.17 nA/cm² vs Spec Max 10.0 nA/cm² ? forecast exceeds limit
- **Conformal Interval (90%)**: +/- 2.55
- **Safety Slope Margin**: -0.0359 (allowed - measured max slope)
