...
**Component ID**: `FINAL_LOT_0054_0005`
**Family**: `IMAGE_SENSOR`
...
- **Measured at 24h**: 2.71
- **Predicted 168h**: 4.94 nA/cm² vs Spec Max 10.0 nA/cm²
- **Conformal Interval (90%)**: +/- 2.55
- **Safety Slope Margin**: -0.0005 (allowed - measured max slope)
