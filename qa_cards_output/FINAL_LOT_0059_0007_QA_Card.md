...
**Component ID**: `FINAL_LOT_0059_0007`
**Family**: `IMAGE_SENSOR`
...
- **Measured at 24h**: 11.35
- **Predicted 168h**: 18.55 nA/cm² vs Spec Max 10.0 nA/cm² ? forecast exceeds limit
- **Conformal Interval (90%)**: +/- 2.55
- **Safety Slope Margin**: -0.3725 (allowed - measured max slope)
